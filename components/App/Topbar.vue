...
const unoConfig = useAppConfig().uno;
</script>
<template>
    <header
        :class="`fixed top-0 right-0 left-0 w-full flex bg-primary-600 justify-between items-center text-white p-2 h-14 shadow-md border-b-[0.5] border-gray-100`">
